...
public class MapPlaceActivity extends AppCompatActivity
    ...
    public void onMapReady(final GoogleMap googleMap) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions(MapPlaceActivity.this, REQUIRED_PERMISSIONS,
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(arrival, 10));
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MapPlaceActivity.this);
